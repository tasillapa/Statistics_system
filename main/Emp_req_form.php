                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <?php } else { ?>
                                ...
                                <li class="dropdown user user-menu active aa">
                                    <a href="#" class="dropdown-toggle uu" data-toggle="dropdown">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="erf_write_place" placeholder="สถานที่ที่เขียน">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input type="hidden" class="form-control" id="erf_dateFU" value="<?php $today = date("d/m/y");
                                                    echo $today;
                                                    ?>" placeholder="--/--/----">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input type="hidden" id="erf_toppic" value="ขอลาพักผ่อน"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6"></div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="erf_requst" placeholder="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6"></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="erf_Codid" placeholder="กรอกบัตรเลขที่">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="erf_office" placeholder="กรอกสำนัก/กอง">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="erf_income" placeholder="--/--/----">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="erf_BdateStart_f" placeholder="--/--/----">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control" id="erf_AdateStart_f" placeholder="--/--/----">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="erf_num_f" placeholder="ระบุจำนวนวัน">
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea type="text" class="form-control" id="erf_contact" placeholder="กรอกที่อยู่ที่ติดต่อได้"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="erf_fhone" placeholder="กรอกเบอร์โทรศักท์ที่ติดต่อได้">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6"></div>
...
//                $('.uu').hover(
//                        function () {
//                            $(document).find('.aa').addClass("open");
//                        }
//                );
                $(".btn-save").click(function () {
                    var arr = [];
                    arr.push($('#erf_write_place').val(), convertDigitIn($('#erf_dateFU').val()), $('#erf_toppic').val(), $('#erf_requst').val(), $('#erf_name').val(), $('#erf_Codid').val(), $('#erf_office').val()
                            , convertDigitIn($('#erf_income').val()), convertDigitIn($('#erf_BdateStart_f').val()), convertDigitIn($('#erf_AdateStart_f').val()), $('#erf_num_f').val(), $('#erf_contact').val(), $('#erf_fhone').val());
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data == '1') {
                                window.location.href = 'ERF_print.php';
                            } else {
...
//                });
                ...
                $('#erf_AdateStart_f').datepicker({
                    autoclose: true,
                    format: 'dd/mm/yyyy'
                });
                $('#erf_income').datepicker({
                    autoclose: true,
                    format: 'dd/mm/yyyy'
                });
